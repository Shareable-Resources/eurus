-- Deploy eurus-backend-db-report:20211203_alter_report_audit_generate to pg
...
CREATE OR REPLACE FUNCTION public.report_audit_generate(var_selected_date date)
 RETURNS TABLE(asset_name character varying, 
 	...
 	mainnet_cold_balance_change numeric, 
 	side_chain_to_mainnet_admin_fee numeric, 
 	side_chain_to_mainnet_count integer, 
 	side_chain_to_mainnet_sum numeric, 
 	mainnet_to_side_chain_count integer, 
 	mainnet_to_side_chain_sum numeric, 
 	side_chain_to_side_chain_count integer, 
 	side_chain_to_side_chain_sum numeric, 
 	selected_date date, 
