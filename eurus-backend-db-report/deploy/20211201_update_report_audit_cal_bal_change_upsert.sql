-- Deploy eurus-backend-db-user:20211201_update_report_audit_cal_bal_change_upsert to pg
...
begin
	insert into report_audit (
			 ...
			 created_date,
			 last_modified_date,
			 mainnet_hot_wallet_current_balance,
			 mainnet_hot_wallet_previous_balance
	)
	select 
	...
	do
		update
			set
				...
				mainnet_hot_wallet_current_balance = EXCLUDED.mainnet_hot_wallet_current_balance,
				mainnet_hot_wallet_previous_balance = EXCLUDED.mainnet_hot_wallet_previous_balance,
	...
	insert into report_audit (
			 ...
			 created_date,
			 last_modified_date,
			 mainnet_cold_wallet_current_balance,
			 mainnet_cold_wallet_previous_balance
	)
	select 
		p_asset_name as asset_name,
		p_selected_date as selected_date,
	...
	do
		update
			set
				...
				mainnet_cold_wallet_current_balance = EXCLUDED.mainnet_cold_wallet_current_balance,
				mainnet_cold_wallet_previous_balance = EXCLUDED.mainnet_cold_wallet_previous_balance,
				last_modified_date = now();
	GET DIAGNOSTICS row_count = ROW_COUNT;
