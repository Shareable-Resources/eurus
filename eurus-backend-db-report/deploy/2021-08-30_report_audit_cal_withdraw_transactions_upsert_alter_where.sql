-- Deploy eurus-backend-db-report:2021-08-30_report_audit_cal_withdraw_transactions_upsert_alter_where to pg
...
begin
	...
	from 
		...
		where created_date::date=var_selected_date AND wt.status=80
