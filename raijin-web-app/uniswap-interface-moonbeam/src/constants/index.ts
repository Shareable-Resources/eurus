import { ChainId, JSBI, Percent, Token, WDEV } from 'moonbeamswapdada'
...
export const ROUTER_ADDRESS: { [key: string]: string } = {
  ...
  [ChainId.BESUDEV]: '0x1c874A3Ce03F373E8b18196ff3bc2Ae3Fd1557A1',
...
const WDEV_ONLY: ChainTokenList = {
  ...
  [ChainId.BESUDEV]: [WDEV[ChainId.BESUDEV]],
}
