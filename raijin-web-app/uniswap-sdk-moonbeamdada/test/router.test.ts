  ...
  describe('#swapCallParameters', () => {
    describe('exact in', () => {
      it('ether to token1', () => {
        ...
        expect(result.methodName).toEqual('swapExactEUNForTokens')
      ...
      it('token1 to ether', () => {
        ...
        expect(result.methodName).toEqual('swapExactTokensForEUN')
        expect(result.args.slice(0, -1)).toEqual([
          '0x64',
          '0x51',
    ...
    describe('exact out', () => {
      it('ether to token1', () => {
        ...
        expect(result.methodName).toEqual('swapEUNForExactTokens')
        expect(result.args.slice(0, -1)).toEqual([
          '0x64',
          [WETH[ChainId.MAINNET].address, token0.address, token1.address],
          '0x0000000000000000000000000000000000000004',
      ...
      it('token1 to ether', () => {
        ...
        expect(result.methodName).toEqual('swapTokensForExactEUN')
        expect(result.args.slice(0, -1)).toEqual([
          '0x64',
          '0x80',
          [token1.address, token0.address, WETH[ChainId.MAINNET].address],
    ...
    describe('supporting fee on transfer', () => {
      describe('exact in', () => {
        it('ether to token1', () => {
          ...
          expect(result.methodName).toEqual('swapExactEUNForTokensSupportingFeeOnTransferTokens')
          expect(result.args.slice(0, -1)).toEqual([
            '0x51',
            [WETH[ChainId.MAINNET].address, token0.address, token1.address],
            '0x0000000000000000000000000000000000000004',
        ...
        it('token1 to ether', () => {
          ...
          expect(result.methodName).toEqual('swapExactTokensForEUNSupportingFeeOnTransferTokens')
          expect(result.args.slice(0, -1)).toEqual([
            '0x64',
            '0x51',
            [token1.address, token0.address, WETH[ChainId.MAINNET].address],
