...
describe('Trade', () => {
  ...
  it('can be constructed with EUN as input', () => {
  ...
  it('can be constructed with EUN as input for exact output', () => {
    const trade = new Trade(
  ...
  it('can be constructed with EUN as output', () => {
    const trade = new Trade(
  ...
  describe('#bestTradeExactOut', () => {
    ...
    it('works for EUN currency input', () => {
      const result = Trade.bestTradeExactOut(
        [pair_weth_0, pair_0_1, pair_0_3, pair_1_3],
        DEV,
        new TokenAmount(token3, JSBI.BigInt(100))
    ...
    it('works for EUN currency output', () => {
      const result = Trade.bestTradeExactOut(
        [pair_weth_0, pair_0_1, pair_0_3, pair_1_3],
        token3,
        CurrencyAmount.ether(JSBI.BigInt(100))
