...
const theme = (darkMode, color) => ({
  ...
  raijinSwapOrange: darkMode ? '#f48c2c' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#f48c2c' : '#f48c2c',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#f48c2c',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#f48c2c',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #f48c2c30 0%, #fff 0%)`,
})
