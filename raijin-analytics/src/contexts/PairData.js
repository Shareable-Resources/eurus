...
async function getBulkPairData(pairList, ethPrice) {
  // const currentDate =( parseInt(Date.now() / 86400 / 1000) * 86400 - 86400 ) - 2000
  // const [t1, t2, tWeek] = getTimestampsForChanges()
  // let [{ number: b1 }, { number: b2 }, { number: bWeek }] = await getBlocksFromTimestamps([t1, t2, tWeek])
  // let b1 = currentDate - 86400
  // let b2 = currentDate - (2 * 86400)
  // let bWeek = currentDate - (7 * 86400)
  let bWeek = 6402220
  let b1 = bWeek - 7 * 86400
  let b2 = bWeek - 6 * 86400
