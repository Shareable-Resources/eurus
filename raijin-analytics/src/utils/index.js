...
export function getTimestampsForChanges() {
  ...
  const utcCurrentTime = parseInt((Date.now() / 86400 / 1000) * 86400 - 86400) - 26588800 // date six months ago
  const t1 = utcCurrentTime - 86400
  const t2 = utcCurrentTime - 86400 * 2
  const tWeek = utcCurrentTime - 86400 * 7
...
export async function getBlockFromTimestamp() {
  ...
  return result.data.transactions[0].timestamp
}
