-- Deploy eurus-backend-db-user:create_kyc_country_codes to pg
...
COMMENT ON COLUMN kyc_country_codes.code IS 'Two-letter country code (ISO 3166-1 alpha-2)';
COMMENT ON COLUMN kyc_country_codes.name IS 'English country name';
COMMENT ON COLUMN kyc_country_codes.full_name IS 'Full English country name';
COMMENT ON COLUMN kyc_country_codes.iso3 IS 'Three-letter country code (ISO 3166-1 alpha-3)';
COMMENT ON COLUMN kyc_country_codes.number IS 'Three-digit country number (ISO 3166-1 numeric)';
COMMENT ON COLUMN kyc_country_codes.continent_code IS 'Which dontinent this country in';

INSERT INTO "kyc_country_codes" ("code", "continent_code", "name", "iso3", "number", "full_name") VALUES
