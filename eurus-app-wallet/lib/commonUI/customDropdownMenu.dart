...
class _DropdownMenuPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    print('customDropdown:: ${size.width}');
    ...
    final Tween<double> bottom = new Tween<double>(
      begin: (top.begin ?? 0.0 + _kMenuItemHeight)
...
class _DropdownMenuState<T> extends State<_DropdownMenu<T>> {
  ...
  Widget build(BuildContext context) {
        ...
        children.add(new FadeTransition(
          ...
          child: new InkWell(
            ...
            onTap: () async {
              ...
              final onTap = route.items[itemIndex].onTap;
              if (onTap != null) onTap();
            },
          ),
        ));
    ...
    return _fadeOpacity != null && _resize != null
        ? new FadeTransition(
...
class _DropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    ...
    final double width = math.min(constraints.maxWidth, 200);
...
//    _updateSelectedIndex();
  ...
  double get _denseButtonHeight {
    return math.max(_textStyle?.fontSize ?? 0.0,
