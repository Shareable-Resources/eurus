...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'USDC', ownedProxy)
    ...
    //await usdt20obj.methods.init("USDC", "USDC", 13242013521397079n, 6).send(await deployHelper.rinkebyCallParams(accounts));
