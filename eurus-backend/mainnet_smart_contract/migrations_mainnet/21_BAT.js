...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'BAT', ownedProxy)
    ...
    //await usdt20obj.methods.init("BAT", "BAT", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
