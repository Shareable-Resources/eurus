...
module.exports = async (deployer) => {
    ...
    try {
        ...
        let eurusInternalConfigObj = new web3.eth.Contract(eurusInternalConfigJson.abi, eurusInternalConfigAddr.address);
        ...
        let receipt2 = await eurusUserDepositObj.methods.setEurusInternalConfigAddress(eurusInternalConfigAddr.address).send(networkSetting);
        console.log(receipt2)

        console.log("eurusUserDeposit.setEurusPlatformAddress")
        let receipt3 = await eurusUserDepositObj.methods.setEurusPlatformAddress(eurusPlatformWalletAddr.address).send(networkSetting);
        ...
        let receipt4 = await etherForwardProxyObj.methods.setEtherForwardAddress(eurusPlatformWalletAddr.address).send(networkSetting);
