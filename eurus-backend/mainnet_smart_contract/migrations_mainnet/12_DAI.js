...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'DAI', ownedProxy)
    ...
    //await usdt20obj.methods.init("DAI", "DAI", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
