...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'VEN', ownedProxy)
    ...
    //await usdt20obj.methods.init("VEN", "VEN", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
