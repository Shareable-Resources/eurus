...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'SUSHI', ownedProxy)
    ...
    //await usdt20obj.methods.init("SUSHI", "SUSHI", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
