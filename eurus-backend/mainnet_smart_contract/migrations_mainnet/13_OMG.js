...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'OMG', ownedProxy)
    ...
    //await usdt20obj.methods.init("OMG", "OMG", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
