...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'ZRX', ownedProxy)
    ...
    //await usdt20obj.methods.init("ZRX", "ZRX", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
