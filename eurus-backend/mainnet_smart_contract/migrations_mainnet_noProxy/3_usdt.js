...
module.exports = async function (deployer) {
    ...
    await deployHelper.deploy(deployer, usdt, 'USDT', ownedProxy)
    ...
    //await usdt20obj.methods.init("USDT", "USDT", 13242013521397079n, 6).send(await deployHelper.rinkebyCallParams(accounts));
