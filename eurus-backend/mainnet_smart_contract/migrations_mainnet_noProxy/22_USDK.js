...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'USDK', ownedProxy)
    ...
    //await usdt20obj.methods.init("USDK", "USDK", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
