...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'COMP', ownedProxy)
    ...
    //await usdt20obj.methods.init("COMP", "COMP", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
