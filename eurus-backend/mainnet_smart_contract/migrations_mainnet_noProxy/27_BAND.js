...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'BAND', ownedProxy)
    ...
    //await usdt20obj.methods.init("BAND", "BAND", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
