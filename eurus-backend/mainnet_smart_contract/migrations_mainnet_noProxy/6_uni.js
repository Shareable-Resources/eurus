...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'UNI', ownedProxy)
    ...
    //await usdt20obj.methods.init("UNI", "UNI", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
