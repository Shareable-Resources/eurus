    ...
    >
      ...
      >
        ...
        >
          <el-input
            readonly
            :value="dialogForm.userGroup && $t(`options.${USER_GROUP[dialogForm.userGroup]}`) ||''"
          />
        </el-form-item>
        <el-form-item
...
export default {
    ...
    return {
        ...
        columns: [
          {
            ...
            model: 'userNo',
            label: 'common.userNo',
            placeholder: 'user.privateChainAddr'
          },
          {
            type: 'input',
            model: 'email',
      ...
      tableData: {
        ...
        columns: [
          ...
          {
            type: 'btns',
            label: 'user.transRecord',
            btns: [
              {
                type: 'btn',
                label: 'common.check',
                fn: this.jump2transRecord
              }
            ]
          },
          {
  ...
  methods: {
    ...
    jump2transRecord(row) {
      const { userNo } = row
      this.$router.push({ name: `Transaction`, params: { id: userNo }})
    },
    handleClick(row) {
      this.isEdit = false
