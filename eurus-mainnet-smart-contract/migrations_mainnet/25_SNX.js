...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'SNX', ownedProxy)
    ...
    //await usdt20obj.methods.init("SNX", "SNX", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
