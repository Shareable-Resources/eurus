...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'ZIL', ownedProxy)
    ...
    //await usdt20obj.methods.init("ZIL", "ZIL", 13242013521397079n, 12).send(await deployHelper.rinkebyCallParams(accounts));
