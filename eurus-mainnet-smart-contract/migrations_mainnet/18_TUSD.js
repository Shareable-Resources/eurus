...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'TUSD', ownedProxy)
    ...
    //await usdt20obj.methods.init("TUSD", "TUSD", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
