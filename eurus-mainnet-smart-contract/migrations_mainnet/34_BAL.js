...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'BAL', ownedProxy)
    ...
    //await usdt20obj.methods.init("BAL", "BAL", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
