...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'MKR', ownedProxy)
    ...
    //await usdt20obj.methods.init("MKR", "MKR", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
