...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'BNB', ownedProxy)
    ...
    //await usdt20obj.methods.init("BNB", "BNB", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
