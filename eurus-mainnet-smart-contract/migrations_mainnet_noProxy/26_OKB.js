...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'OKB', ownedProxy)
    ...
    //await usdt20obj.methods.init("OKB", "OKB", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
