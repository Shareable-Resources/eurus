...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'RSR', ownedProxy)
    ...
    //await usdt20obj.methods.init("RSR", "RSR", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
