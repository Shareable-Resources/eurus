...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'YFI', ownedProxy)
    ...
    //await usdt20obj.methods.init("YFI", "YFI", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
