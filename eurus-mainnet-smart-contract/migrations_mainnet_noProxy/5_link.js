...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'LINK', ownedProxy)
    ...
    //await usdt20obj.methods.init("LINK", "LINK", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
