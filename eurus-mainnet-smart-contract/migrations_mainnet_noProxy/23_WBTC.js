...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'WBTC', ownedProxy)
    ...
    //await usdt20obj.methods.init("WBTC", "WBTC", 13242013521397079n, 8).send(await deployHelper.rinkebyCallParams(accounts));
