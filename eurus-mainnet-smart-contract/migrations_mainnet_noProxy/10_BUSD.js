...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'BUSD', ownedProxy)
    ...
    //await usdt20obj.methods.init("BUSD", "BUSD", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
