...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'PAX', ownedProxy)
    ...
    //await usdt20obj.methods.init("PAX", "PAX", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
