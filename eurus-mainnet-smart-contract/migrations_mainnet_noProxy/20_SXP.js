...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'SXP', ownedProxy)
    ...
    //await usdt20obj.methods.init("SXP", "SXP", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
