...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'AAVE', ownedProxy)
    ...
    //await usdt20obj.methods.init("AAVE", "AAVE", 13242013521397079n, 18).send(await deployHelper.rinkebyCallParams(accounts));
