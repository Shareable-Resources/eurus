...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'cDAI', ownedProxy)
    ...
    //await usdt20obj.methods.init("cDAI", "cDAI", 13242013521397079n, 8).send(await deployHelper.rinkebyCallParams(accounts));
