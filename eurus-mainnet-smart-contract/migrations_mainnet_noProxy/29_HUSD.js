...
module.exports = async function (deployer) {
    ...
    await deployHelper.deployWithProxy(deployer, usdt, 'HUSD', ownedProxy)
    ...
    //await usdt20obj.methods.init("HUSD", "HUSD", 13242013521397079n, 8).send(await deployHelper.rinkebyCallParams(accounts));
