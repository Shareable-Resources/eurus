...
import { Currency, currencyEquals, DEV, TokenAmount, WDEV } from 'moonbeamswapdada'
...
export default function AddLiquidity({
  ...
  async function onAdd() {
    ...
    if (currencyA === DEV || currencyB === DEV) {
      ...
      estimate = router.estimateGas.addLiquidityEUN
      method = router.addLiquidityEUN
      args = [
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/${currencyIdA ? currencyIdA : 'EUN'}/${newCurrencyIdB}`)
      }
    },
