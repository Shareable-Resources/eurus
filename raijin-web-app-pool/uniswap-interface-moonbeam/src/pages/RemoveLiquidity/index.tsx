...
import { Currency, currencyEquals, DEV, Percent, WDEV } from 'moonbeamswapdada'
...
export default function RemoveLiquidity({
  ...
  async function onAttemptToApprove() {
    ...
    const domain = {
      name: 'EurusSwap', //correct domain name!!!!!!!!!!!!!!!!!!!!!!!
      version: '1',
      chainId: chainId,
  ...
  async function onRemove() {
    ...
    if (approval === ApprovalState.APPROVED) {
      // removeLiquidityETH
      if (oneCurrencyIsETH) {
        methodNames = ['removeLiquidityEUN', 'removeLiquidityEUNSupportingFeeOnTransferTokens']
        args = [
    ...
    // we have a signataure, use permit versions of remove liquidity
      ...
      if (oneCurrencyIsETH) {
        methodNames = ['removeLiquidityEUNWithPermit', 'removeLiquidityEUNWithPermitSupportingFeeOnTransferTokens']
        args = [
          currencyBIsETH ? tokenA.address : tokenB.address,
          liquidityAmount.raw.toString(),
          amountsMin[currencyBIsETH ? Field.CURRENCY_A : Field.CURRENCY_B].toString(),
                    ...
                    {chainId && (oneCurrencyIsWDEV || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          ...
                          <StyledInternalLink
                            to={`/remove/${
                              currencyA && currencyEquals(currencyA, WDEV[chainId]) ? 'EUN' : currencyIdA
                            }/${currencyB && currencyEquals(currencyB, WDEV[chainId]) ? 'EUN' : currencyIdB}`}
                          >
                            Receive EUN
                          </StyledInternalLink>
                        ) : null}
